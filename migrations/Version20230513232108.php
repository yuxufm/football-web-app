 ...
 */
final class Version20230513232108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE player_transfers (id INT AUTO_INCREMENT NOT NULL, player_id INT NOT NULL, buying_team_id INT NOT NULL, selling_team_id INT NOT NULL, transfer_amount INT NOT NULL, transfer_date DATETIME NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_20260C2199E6F5DF (player_id), INDEX IDX_20260C214683D018 (buying_team_id), INDEX IDX_20260C21952E86F3 (selling_team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
